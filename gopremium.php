    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="gopremium.php">go premium now</a></li>
          </ul>
        </div>
      </nav>
      ...
      <div class="center">
          ...
          <form method ="post" action="">
            ...
            <input type="submit" class="btnsubmit" value="Explore now"  class="glyphicon log-in">
            </div>
          </form></center>
      </div>
...
if($usern)
{
$sql = "SELECT confirm FROM register WHERE password='$pass'";
$result = $connect->query($sql);
$row = $result->fetch_assoc();
if($row["confirm"]=== 'yes')
header("Location:premium.htm");
}
?>
